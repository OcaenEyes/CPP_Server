...
class SofaRpcMeta final :
 ...
 public:
  ...
  explicit constexpr SofaRpcMeta(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline std::string* SofaRpcMeta::release_method() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return method_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
