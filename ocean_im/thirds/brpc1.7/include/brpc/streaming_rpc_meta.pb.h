...
class StreamSettings final :
 ...
 public:
  ...
  explicit constexpr StreamSettings(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
class StreamFrameMeta final :
 ...
 public:
  ...
  explicit constexpr StreamFrameMeta(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT ::brpc::Feedback* release_feedback();
...
class Feedback final :
 ...
 public:
  ...
  ~Feedback() override;
  explicit constexpr Feedback(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline void StreamFrameMeta::set_allocated_feedback(::brpc::Feedback* feedback) {
  ...
  if (feedback) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalHelper<::brpc::Feedback>::GetOwningArena(feedback);
