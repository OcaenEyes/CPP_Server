...
class RpcDumpMeta final :
 ...
 public:
  ...
  explicit constexpr RpcDumpMeta(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_nshead();
...
void RpcDumpMeta::set_nshead(ArgT0&& arg0, ArgT... args) {
 _has_bits_[0] |= 0x00000010u;
 nshead_.SetBytes(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void RpcDumpMeta::_internal_set_nshead(const std::string& value) {
  _has_bits_[0] |= 0x00000010u;
  nshead_.Set(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, value, GetArenaForAllocation());
}
inline std::string* RpcDumpMeta::_internal_mutable_nshead() {
  _has_bits_[0] |= 0x00000010u;
  return nshead_.Mutable(::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::EmptyDefault{}, GetArenaForAllocation());
}
inline std::string* RpcDumpMeta::release_nshead() {
  ...
  _has_bits_[0] &= ~0x00000010u;
  return nshead_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
