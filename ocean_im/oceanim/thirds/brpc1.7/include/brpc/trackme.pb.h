...
class TrackMeRequest final :
 ...
 public:
  ...
  explicit constexpr TrackMeRequest(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
  ...
  PROTOBUF_MUST_USE_RESULT std::string* release_server_addr();
...
class TrackMeResponse final :
 ...
 public:
  ...
  explicit constexpr TrackMeResponse(::PROTOBUF_NAMESPACE_ID::internal::ConstantInitialized);
...
inline std::string* TrackMeRequest::release_server_addr() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return server_addr_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
